...
public class MyClass1 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		try {
			...
			Thread.sleep(8000);
			driver.findElement(By.xpath("//span[text()='Customer Name']//following::input")).sendKeys("Mounika");
			Thread.sleep(3000);
			driver.findElement(By.xpath("//span[text()='House Number']//following::input")).sendKeys("111");
			Thread.sleep(3000);
			driver.findElement(By.xpath("//span[text()='Street']//following::input")).sendKeys("7th Cross");
			Thread.sleep(3000);
			driver.findElement(By.xpath("//span[text()='City']//following::input")).sendKeys("Bangalore");
			Thread.sleep(3000);
			...
			Thread.sleep(3000);
			driver.findElement(By.xpath("//div[text()=\"West Bengal\"]")).click();
			Thread.sleep(3000);
			driver.findElement(By.xpath("//span[text()='Mobile Number']//following::input")).sendKeys("9148095373");
			Thread.sleep(3000);
			driver.findElement(By.xpath("//span[text()='Zip Code']//following::input")).sendKeys("560001");
			Thread.sleep(3000);
